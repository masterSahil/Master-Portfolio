...
import {  Send, Mail, MapPin, Phone,  ArrowRight, CheckCircle2, AlertCircle, Loader2, Sparkles, ExternalLink } from "lucide-react";
        ...
        >
          <div className="relative p-6 rounded-xl bg-[#0a0f0b] border border-white/10 flex flex-col gap-6 h-full overflow-hidden group/card">
              ...
              <div className="grid grid-cols-1 gap-3 mt-auto relative z-10">
                    <SocialButton icon={FaGithub} label="GitHub" href={CONTACT_DETAILS.github} />
                    <SocialButton icon={FaLinkedin} label="LinkedIn" href={CONTACT_DETAILS.linkedin} />
              </div>
          </div>
        </motion.div>
