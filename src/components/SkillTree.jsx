  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-125 bg-gradient-to-b from-green-900/10 via-transparent to-transparent opacity-50" />
      ...
      <div className="relative z-10 w-full max-w-350 px-4 flex flex-col items-center">
        ...
        >
          ...
          <div className="absolute top-20 lg:top-28 left-1/2 -translate-x-1/2 h-16 lg:h-24 w-0.5 bg-gradient-to-b from-green-500 to-green-500/40 shadow-[0_0_15px_#22c55e]"></div>
        </motion.div>
        ...
        <div className="relative w-full flex flex-col lg:flex-row justify-center items-center lg:items-start gap-12 lg:gap-6 xl:gap-10">
          ...
          <div className="hidden lg:block absolute top-10 left-[5%] right-[5%] h-0.5 bg-gradient-to-r from-transparent via-green-500/70 to-transparent" />

          {/* Mobile Connector: Vertical Spine Background */}
          <div className="lg:hidden absolute -top-7.5 bottom-20 left-1/2 -translate-x-1/2 w-0.5 bg-gradient-to-b from-green-500/40 via-green-500/10 to-transparent pointer-events-none" />
