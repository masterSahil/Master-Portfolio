...
const TECH_STACK = [
  ...
  { name: "Express.js", icon: Terminal, level: "Expert", color: "text-white" },
  ...
  { name: "Firebase", icon: Flame, level: "Advanced", color: "text-orange-500" },
  { name: "Cloudinary", icon: Database, level: "Advanced", color: "text-blue-300" },
  
  // Tools & Languages
  { name: "Git/GitHub", icon: GitBranch, level: "Strong", color: "text-red-400" },
  ...
  { name: "C / C++", icon: Cpu, level: "Strong", color: "text-blue-600" },
];
